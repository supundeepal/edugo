...
<head>
    ...
    ?>
    <title><?php echo e($instituteName); ?> | <?php echo e(config('app.name', 'EduGo')); ?></title>
    
    <link rel="icon" type="image/png" href="<?php echo e(asset('app-icon.png')); ?>">
    ...
    <div class="container-fluid px-4 px-xl-5">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-between mb-4 pb-4" style="border-bottom: 2px solid rgba(163, 177, 198, 0.15); gap: 16px;">
            ...
            <div class="d-flex align-items-center" style="gap: 16px;">
                <a class="neu-common-btn neu-brand" href="<?php echo e($isTeacher ? '/teacher-dashboard' : ($isOwner ? '/owner/dashboard' : '/staff/dashboard')); ?>">
                ...
                <?php if($isOwner || $isStaff): ?>
                    <div class="neu-common-btn d-none d-md-flex" style="cursor: default;">
                        <i class="bi bi-buildings-fill icon-primary"></i> <?php echo e($instituteName); ?>
            ...
            <div class="d-flex align-items-center flex-wrap" style="gap: 16px;">
                ...
                <?php if($isTeacher || $isOwner || $isStaff): ?>
                <div class="dropdown">
                    <button class="neu-common-btn neu-icon-only" data-bs-toggle="dropdown" aria-expanded="false">
                        <i class="bi <?php echo e($unreadCount > 0 ? 'bi-bell-fill icon-warning' : 'bi-bell'); ?>"></i>
                        <?php if($unreadCount > 0): ?>
                            <span class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-danger" style="font-size: 0.65rem;"><?php echo e($unreadCount); ?></span>
                        <?php endif; ?>
                    </button>
                    <ul class="dropdown-menu dropdown-menu-end neu-dropdown-menu">
                        <li class="px-3 py-2 fw-bold text-neu mb-3 d-flex align-items-center justify-content-between border-bottom pb-3" style="font-size: 1.1rem;">
                            ...
                            <span class="badge rounded-pill bg-primary px-3 py-1"><?php echo e($unreadCount); ?> New</span>
                        </li>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $noti): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <li>
                                    <a class="dropdown-item neu-dropdown-item" href="/admin-materials">
                                        <div class="fw-bold text-neu mb-1" style="font-size: 0.95rem; line-height: 1.4;"><?php echo e($noti->message); ?></div>
                                        <small class="opacity-75 d-flex align-items-center fw-medium text-neu" style="font-size: 0.8rem;">
                                            <i class="bi bi-clock-history me-2 text-primary"></i> <?php echo e($noti->created_at->diffForHumans()); ?>
                ...
                <?php if(Auth::check() || $isTeacher): ?>
                <div class="neu-welcome-text d-none d-lg-flex">
                    Welcome, <?php echo e(strtok($userName, " ")); ?> 👋
                    <span class="neu-welcome-role role-<?php echo e($userRole); ?>"><?php echo e($userRole); ?></span>
                </div>
                <?php endif; ?>
                
                <?php $logoutUrl = ($isOwner || $isStaff) ? '/owner-logout' : '/teacher-logout'; ?>
                <a href="<?php echo e($logoutUrl); ?>" class="neu-common-btn" style="color: var(--neu-danger) !important;">
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        const successMsg = "<?php echo e(session('success')); ?>";
        const errorMsg = "<?php echo e(session('error')); ?>";
...
</html><?php /**PATH C:\Users\Supun\Desktop\EduGo_Live_Code\resources\views/layout.blade.php ENDPATH**/ ?>