...
<div class="container-fluid mt-4 mb-5 px-xl-4">
    ...
    <div class="d-flex flex-column flex-sm-row align-items-sm-center mb-5">
        ...
        <div class="d-flex align-items-center">
            ...
            <h2 class="fw-bold text-neu mb-0"><?php echo e($teacher->name); ?>'s Classes</h2>
        </div>
    </div>
    ...
    <div class="row g-4 g-lg-5">
        ...
        <div class="col-md-6 col-lg-4 col-xl-3">
            <div class="card neu-card p-4 h-100 d-flex flex-column text-center">
                ...
                <h4 class="fw-bold text-neu mb-2" style="font-size: 1.3rem;"><?php echo e($course->course_name); ?></h4>
                
                <p class="text-neu mb-0" style="opacity: 0.7; font-weight: 600;">
                    Course Fee: <span style="color: var(--neu-primary);">Rs. <?php echo e(number_format($course->fee, 2)); ?></span>
                </p>
                
                <div class="neu-divider"></div>
                
                <div class="mt-auto">
                    <a href="/teacher-salary/<?php echo e($course->id); ?>" class="neu-btn w-100" style="color: #10b981;">
        ...
        <div class="col-12 text-center py-5">
            ...
            <p class="text-neu" style="opacity: 0.5;"><?php echo e($teacher->name); ?> doesn't have any assigned classes yet.</p>
        </div>
        <?php endif; ?>
    </div>
</div>
...
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Supun\Desktop\EduGo_Live_Code\resources\views/teacher_courses.blade.php ENDPATH**/ ?>