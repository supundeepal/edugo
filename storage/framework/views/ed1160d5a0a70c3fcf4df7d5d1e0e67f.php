...
<head>
    ...
    <link rel="apple-touch-icon" href="<?php echo e(asset('app-icon.png')); ?>">
    ...
    <style>
        ...
        .theme-toggle {
            ...
            box-shadow: 5px 5px 10px var(--neu-shadow-dark), 
                       -5px -5px 10px var(--neu-shadow-light);
            display: flex; justify-content: center; align-items: center;
            cursor: pointer; border: none; color: var(--neu-warning); font-size: 20px; transition: 0.3s;
        }
        .theme-toggle:active {
            box-shadow: inset 3px 3px 6px var(--neu-shadow-dark), 
                        inset -3px -3px 6px var(--neu-shadow-light);
...
<body>
    ...
    <div class="login-card text-center">
        ...
        <h2 class="fw-bold mb-1" style="color: var(--neu-primary); letter-spacing: -0.5px;"><?php echo e(config('app.name')); ?></h2>
        <h6 class="fw-bold text-neu mb-3 opacity-75">Admin Portal</h6>
        
        <p class="text-neu-muted mb-4" style="font-size: 0.9rem;">Please enter your credentials to proceed.</p>
        ...
        <?php if(session('success')): ?>
            <div class="neu-alert fw-medium text-success" style="border-color: rgba(25, 135, 84, 0.2);">
        ...
        <form action="/owner-login" method="POST">
            ...
            <div class="neu-input-group">
                ...
                <input type="text" name="username" class="neu-input" placeholder="Email / Username" required>
            </div>
            <div class="neu-input-group">
        ...
        <div class="mt-2" style="font-size: 0.9rem;">
            <a href="/teacher-login" class="text-decoration-none fw-bold" style="color: var(--neu-text); opacity: 0.8; transition: 0.2s;" onmouseover="this.style.color='var(--neu-primary)'" onmouseout="this.style.color='var(--neu-text)'">
                <i class="bi bi-person-workspace me-1"></i> Switch to Teacher Portal
            </a>
        </div>
    </div>
...
</html><?php /**PATH C:\Users\Supun\Desktop\EduGo_Live_Code\resources\views/login.blade.php ENDPATH**/ ?>