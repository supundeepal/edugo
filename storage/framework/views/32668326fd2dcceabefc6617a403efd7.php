...
<body>
    ...
    <div class="container text-center">
        ...
        <div class="mb-5 pb-3">
            <h1 class="fw-bold mb-3" style="letter-spacing: -1px;">Welcome back, <span style="color: var(--neu-primary);"><?php echo e(session('teacher_name')); ?></span>! 👋</h1>
        ...
        <div class="row justify-content-center g-4 mb-5 pb-4" style="max-width: 900px; margin: 0 auto;">
            ...
            <div class="col-6 col-md-4">
                <a href="/teacher/set-institute/<?php echo e($institute->id); ?>" class="institute-card">
                    <div class="icon-wrapper">
                        <i class="bi bi-buildings-fill"></i>
                    </div>
                    <h5 class="fw-bold mb-0 text-truncate px-2"><?php echo e($institute->name); ?></h5>
                </a>
            </div>
...
</html><?php /**PATH C:\Users\Supun\Desktop\EduGo_Live_Code\resources\views/teacher_select_institute.blade.php ENDPATH**/ ?>