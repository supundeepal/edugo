...
<div class="container-fluid mt-4 mb-5 px-xl-4">
    ...
    <div class="d-flex flex-wrap align-items-center justify-content-between mb-5 gap-3">
        <div class="d-flex align-items-center">
            <a href="/teachers/<?php echo e($course->teacher_id); ?>/courses" class="btn neu-btn me-4" data-bs-toggle="tooltip" title="Back to Classes">
            ...
            <div>
                <h3 class="fw-bold mb-0 text-neu"><?php echo e($course->course_name); ?></h3>
    ...
    <?php if(session('success')): ?>
        <div class="alert fw-bold text-center border-0 mb-4 py-3" style="background-color: var(--neu-bg); color: #10b981; border-radius: 15px; box-shadow: 6px 6px 12px var(--neu-shadow-dark), -6px -6px 12px var(--neu-shadow-light);">
            <i class="bi bi-check-circle-fill me-2 fs-5"></i><?php echo e(session('success')); ?>

        </div>
    <?php endif; ?>

    <div class="card neu-card p-4 mb-5">
        <form action="/teacher-salary/<?php echo e($course->id); ?>" method="GET" class="d-flex flex-wrap align-items-center justify-content-center gap-4">
            ...
            <input type="month" name="month" class="form-control neu-input fw-bold fs-5 text-center" style="width: 250px;" value="<?php echo e($selectedMonth); ?>" required>
        ...
        <div class="row g-4 mb-5">
            <div class="col-md-4">
                <div class="value-card">
                    ...
                    <h2 class="fw-bold mb-0 text-neu">Rs. <?php echo e(number_format($salaryData->total_collected, 2)); ?></h2>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="value-card">
                    ...
                    <h2 class="fw-bold mb-0" style="color: #ffb547;">Rs. <?php echo e(number_format($salaryData->institute_share, 2)); ?></h2>
                </div>
            </div>
            ...
            <div class="col-md-4">
                <div class="value-card">
                    ...
                    <h2 class="fw-bold mb-0" style="color: #10b981;">Rs. <?php echo e(number_format($salaryData->teacher_share, 2)); ?></h2>
                </div>
            </div>
        </div>

        <div class="pay-action-card">
            <?php if($salaryData->is_paid): ?>
            ...
            <?php else: ?>
                <div class="d-flex flex-column align-items-center">
                    ...
                    <p class="text-neu mb-4" style="opacity: 0.7; font-size: 1.1rem;">Ready to release <strong>Rs. <?php echo e(number_format($salaryData->teacher_share, 2)); ?></strong> to the instructor?</p>
                    
                    <form action="/pay-teacher" method="POST" class="m-0">
                        <?php echo csrf_field(); ?>
                        <input type="hidden" name="course_id" value="<?php echo e($course->id); ?>">
                        <input type="hidden" name="month" value="<?php echo e($selectedMonth); ?>">
                        <input type="hidden" name="amount" value="<?php echo e($salaryData->teacher_share); ?>">
    ...
    <?php else: ?>
        <div class="card neu-card p-5 text-center">
            ...
            <p class="text-neu opacity-50 fs-5 mb-0">There are no student payments recorded for "<?php echo e($course->course_name); ?>" in <?php echo e(\Carbon\Carbon::parse($selectedMonth)->format('F Y')); ?>.</p>
        </div>
    <?php endif; ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Supun\Desktop\EduGo_Live_Code\resources\views/teacher_salary_details.blade.php ENDPATH**/ ?>