                        ...
                        @foreach($staffs as $staff)
                            <div class="neu-table-row">
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h6 class="fw-bold text-neu mb-0">{{ $staff->name }}</h6>
                                        <small class="text-neu" style="opacity: 0.6;"><i class="bi bi-envelope me-1"></i> {{ $staff->email }}</small>
                                    </div>
                                </div>
                                
                                <div class="d-flex gap-2">
                                    <button type="button" class="neu-action-btn view-btn" data-bs-toggle="modal" data-bs-target="#viewStaffModal{{ $staff->id }}" title="View & Edit">
                                        <i class="bi bi-eye-fill"></i>
                                    </button>

                                    <a href="/manage-staff/{{ $staff->id }}/delete" class="neu-action-btn delete-btn" onclick="return confirm('Are you sure you want to delete this staff account?')" title="Delete">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body px-4 pt-4 pb-4">
                                            ...
                                            <div class="info-box">
                                                ...
                                                <h5 class="fw-bold text-neu mb-0 mt-1">{{ $staff->name }}</h5>
                                            </div>
                                            
                                            <div class="info-box">
                                                <small class="fw-bold text-primary text-uppercase">Email / Username</small>
                                                <h6 class="fw-bold text-neu mb-0 mt-1">{{ $staff->email }}</h6>
                                            </div>

                                            <div class="info-box d-flex justify-content-between align-items-center">
                                                <div>
                                                    <small class="fw-bold text-primary text-uppercase">Role & Access</small>
                                                    <h6 class="fw-bold text-neu mb-0 mt-1 text-capitalize">{{ $staff->role }}</h6>
                                                </div>
                                            ...
                                            <form action="/manage-staff/{{ $staff->id }}/update-password" method="POST">
                                                @csrf
