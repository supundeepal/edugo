...
<div class="container-fluid mt-4 mb-5 px-xl-4">
    ...
    <div class="d-flex align-items-center justify-content-between mb-5">
        ...
        <div class="d-none d-md-block px-4 py-2" style="border-radius: 12px; box-shadow: inset 3px 3px 6px var(--neu-shadow-dark), inset -3px -3px 6px var(--neu-shadow-light);">
            <span class="fw-bold text-neu" style="opacity: 0.7; font-size: 0.9rem;">Total Instructors: <span style="color: var(--neu-primary);">{{ $teachers->count() }}</span></span>
        </div>
    </div>
            ...
            <tbody>
                ...
                <tr class="neu-row">
                    ...
                    <td class="ps-4">
                        <div class="d-flex align-items-center">
                            @if($teacher->photo)
                                <img src="{{ asset($teacher->photo) }}" class="neu-avatar me-4">
                            @else
                            ...
                            @endif
                            <div>
                                <h5 class="fw-bold text-neu mb-1" style="letter-spacing: -0.3px;">{{ $teacher->name }}</h5>
                                <div class="neu-id-badge">
                                    <i class="bi bi-upc-scan me-1"></i> TCH-{{ str_pad($teacher->id, 3, '0', STR_PAD_LEFT) }}
                                </div>
                            </div>
                        </div>
                    </td>
                    ...
                    <td class="text-end pe-4">
                        <a href="{{ url('/teachers/' . $teacher->id . '/courses') }}" class="neu-pay-pill" data-bs-toggle="tooltip" title="Calculate & Pay Salaries">
